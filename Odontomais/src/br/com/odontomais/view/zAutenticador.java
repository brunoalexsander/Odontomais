...
public class zAutenticador extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					zAutenticador zAutenticador = new zAutenticador();
					zAutenticador.autenticador.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	public void entrar() {
		try {
			...
			if (dao.autenticar(txtEmail.getText(), txtSenha.getText())) {
				txtSenha.setText(null);
				frmPrincipal frmPrincipal = new frmPrincipal(autenticador, true, funcionario.getPermissao());
